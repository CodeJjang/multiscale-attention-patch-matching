...
# my classes
from my_classes import MetricLearningCnn,NormalizeImages,Detect_Features_Points
...
def Detect_Features_Points(net,Img,NumberPoints,Radius,UseNonMaxima,Visualization=False):
    ...
    for k in range(len(recorder.data)-1,0,-1):
        ...
        if isinstance(net[k-1], nn.Conv2d):
            ...
            if (Stride[0] == 1) & (Dilation[0] == 1) & (Pad[0] == int(KernelSize[0]/2)) & (Pad[1] == int(KernelSize[0]/2)):
                continue
