...
import pandas as pd
import hpatches.utils.metrics as metrics
from collections import defaultdict
import time
from tqdm import tqdm
import os.path
from hpatches.utils.hpatch import *
...
def eval_verification(descr,split, tskdir=tskdir):
...
def eval_retrieval(descr,split, tskdir=tskdir): #WIP
